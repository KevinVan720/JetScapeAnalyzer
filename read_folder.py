...
def doAnalysisOnBatch(batchIndexStart, batchIndexEnd):
    ...
    allAnalysis = [
        ...
        pTCut1=[10,15],pTCut2=[8,12],ids1=[421,-421],ids2=[421,-421], outputFileName=outputDir+"DDbar_correlation_high"),
        correlationYieldAnalysis(pThatBins=pThatPair, etaBins=list([-4+0.1*x for x in range(81)]), phiBins=list([-3.2+0.1*x for x in range(65)]),
        pTCut1=[4,6],pTCut2=[2,5],ids1=[421,-421],ids2=[421,-421], outputFileName=outputDir+"DDbar_correlation_low"),
        correlationYieldAnalysis(pThatBins=pThatPair, etaBins=list([-4+0.1*x for x in range(81)]), phiBins=list([-3.2+0.1*x for x in range(65)]),
        pTCut1=[4,8],pTCut2=[10,15],ids1=[421,-421],ids2=[22,-22], outputFileName=outputDir+"Dphoton_correlation")
